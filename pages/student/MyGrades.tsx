...
const MyGrades: React.FC = () => {
    ...
    return (
        <div>
            <h1 className="text-3xl font-bold text-text-primary-dark mb-6">My Grades</h1>
            <Card>
                {loading ? (
                    <p>Loading grades...</p>
                ) : grades.length === 0 ? (
                    <p className="text-center p-8 text-text-secondary-dark">No grades have been recorded yet.</p>
                ) : (
