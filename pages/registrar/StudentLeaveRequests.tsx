...
const StudentLeaveRequestsView: React.FC<{ view: 'Pending' | 'Approved' | 'Rejected' }> = ({ view }) => {
    const { user } = useAuth();
    ...
    const fetchData = useCallback(async () => {
        ...
        setLoading(true);
        // FIX: Corrected method call to fetch leave applications for a registrar.
        const data = await apiService.getLeaveApplicationsForRegistrar(user.branchId);
    ...
    const handleAction = async (requestId: string, status: 'Approved' | 'Rejected') => {
        ...
        try {
            // FIX: Corrected method call to process a leave application.
