...
// FIX: Corrected import to use the specific parentApiService
...
const Events: React.FC = () => {
    ...
    const fetchData = useCallback(async () => {
        ...
        setEvents(data.filter(e => e.status === 'Approved' && (e.audience.includes('All') || e.audience.includes('Parents') || e.audience.includes('Students'))));
        setLoading(false);
    }, [user]);
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mt-6">
                ...
                <Card>
                    ...
                    <div className="space-y-4 max-h-[60vh] overflow-y-auto pr-2">
                        {loading ? <p>Loading...</p> : upcomingEvents.length === 0 ? (
