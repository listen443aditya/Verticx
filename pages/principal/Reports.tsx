...
const reportTypes = [
    { id: 'academic', name: 'Academic Performance Summary', description: 'Overall student performance, subject-wise analysis, and top performers.' },
    { id: 'financial', name: 'Financial Summary', description: 'Detailed breakdown of fee collections, expenses, and budget tracking.' },
    { id: 'attendance', name: 'Full Attendance Log', description: 'Comprehensive attendance records for all students and classes for a selected period.' },
    { id: 'enrollment', name: 'Enrollment Statistics', description: 'Trends in new admissions, re-enrollments, and student attrition rates.' },
];
