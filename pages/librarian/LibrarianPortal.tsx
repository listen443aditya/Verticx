    ...
    return (
        <aside className="w-64 bg-slate-800 text-slate-100 flex flex-col p-4 border-r border-slate-700 h-full">
            ...
            <nav className="flex-1 space-y-2">
                <NavLink to="/librarian/dashboard" className={navLinkClasses}><div className="w-4 h-4 mr-3 flex items-center justify-center flex-shrink-0"><DashboardIcon className="w-full h-full" /></div><span className="truncate min-w-0">Dashboard</span></NavLink>
                <NavLink to="/librarian/books" className={navLinkClasses}><div className="w-4 h-4 mr-3 flex items-center justify-center flex-shrink-0"><LibraryIcon className="w-full h-full" /></div><span className="truncate min-w-0">Book Catalog</span></NavLink>
                <NavLink to="/librarian/issuance" className={navLinkClasses}><div className="w-4 h-4 mr-3 flex items-center justify-center flex-shrink-0"><MoveIcon className="w-full h-full" /></div><span className="truncate min-w-0">Issue & Returns</span></NavLink>
                <NavLink to="/librarian/my-attendance" className={navLinkClasses}><div className="w-4 h-4 mr-3 flex items-center justify-center flex-shrink-0"><AttendanceIcon className="w-full h-full" /></div><span className="truncate min-w-0">My Attendance</span></NavLink>
                <NavLink to="/librarian/apply-leave" className={navLinkClasses}><div className="w-4 h-4 mr-3 flex items-center justify-center flex-shrink-0"><FileTextIcon className="w-full h-full" /></div><span className="truncate min-w-0">Apply for Leave</span></NavLink>
            </nav>
