...
// FIX: The unused and incorrect 'registrarApiService' import has been removed.
...
const AttendanceHistoryModal: React.FC<AttendanceHistoryModalProps> = ({
  ...
  const generateCalendarDays = () => {
    ...
    const days = [];
    const startingBlanks = firstDayOfMonth === 0 ? 6 : firstDayOfMonth - 1; // Adjust for Sunday (0) vs Monday (1) start
