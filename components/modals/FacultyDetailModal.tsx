                  ...
                  <div className="space-y-2 text-sm">
                    ...
                    <div className="flex justify-between pt-2 border-t mt-2">
                      ...
                      <span className="font-bold text-brand-secondary">
                        {teacher.rectificationRequestCount || 0}
                      </span>
                    </div>
                    <div className="flex justify-between">
                      <span className="font-medium text-text-secondary-dark">
                  ...
                  <div className="space-y-3 text-sm">
                    ...
                    <div className="flex justify-between items-center">
                      ...
                      <Button
                        ...
                        onClick={() =>
                          onResetPassword(
                            (teacher as any).userUuid || teacher.id
                          )
                        }
                      >
                        Reset Password
                      ...
                      {isEditingSalary && onUpdateSalary && (
                        <div className="flex items-end gap-2 p-2 bg-slate-100 rounded-lg">
                          ...
                          <Button
                            ...
                            onClick={() => {
                              setIsEditingSalary(false);
                              setSalaryValue(String(teacher.salary || ""));
                            }}
                            disabled={isSavingSalary}
                            className="!py-2"
                          >
