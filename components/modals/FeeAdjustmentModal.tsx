...
const FeeAdjustmentModal: React.FC<FeeAdjustmentModalProps> = ({
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setIsSaving(true);
    try {
      // FIX: The new API service method does not require the user's name as an argument.
      // The backend infers the user from the authentication token.
